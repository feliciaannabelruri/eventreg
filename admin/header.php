...
<head>
  ...
  <title>Admin - Event Registartion System</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>WEEBODING</b></span>
      </a>
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="list_registration.php">
              <i class="fa fa-list-alt"></i> <span>VIEW EVENT REGISTRATION</span>
            </a>
          </li>
